package com.weilaizhe.common.aspect;
 ...
 * @className com.weilaizhe.common.aspect.AllResultAspect
 */
@Aspect
@Component
public class AllResultAspect {
     ...
     */
    @Around("execution(* com.*..controller.*.*(..))&&(!@annotation(com.weilaizhe.common.annotation.OtherReturn))")
