...
public class CommonUtil {
     ...
     * @description: 生成订单号（17位时间戳 + 2位随机数 + 3位数商户ID + 4位随机数)
     ...
     * @description: 微信商品随机获取
     * @param: [weinXinMerchantVO]
     * @return: java.lang.String
     */
    public static String commodity(WechatMerchantVO wechatMerchantVO){
        //获取商品名称
        String goodsName = wechatMerchantVO.getGoodsName();
        if (goodsName!=null){
            // 竖线分隔
            String[] commodityName = goodsName.split("|");
