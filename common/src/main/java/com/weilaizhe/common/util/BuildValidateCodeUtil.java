...
/**
 * @dateTime 2019-03-28 14:17
 * @author: dameizi
 * @description: 构建验证码
 */
public class BuildValidateCodeUtil {
    ...
    private   static Logger logger = LogManager.getLogger(BuildValidateCodeUtil.class);
    ...
    public String getRandcode(HttpServletRequest request, HttpServletResponse response) {
        ...
        session.removeAttribute(CommonConst.RANDOM_CODE_KEY);
        //验证码信息
        session.setAttribute(CommonConst.RANDOM_CODE_KEY, randomString);
        //验证码失效时间 60s
