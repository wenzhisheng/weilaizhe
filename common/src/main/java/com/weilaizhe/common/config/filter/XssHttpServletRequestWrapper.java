package com.weilaizhe.common.config.filter;

import com.weilaizhe.common.exception.DescribeException;
import com.weilaizhe.common.exception.ExceptionEnum;
import com.weilaizhe.common.util.ApplicationContextUtil;
...
public class XssHttpServletRequestWrapper extends HttpServletRequestWrapper {
    ...
    private String checkXSS(String value) {
        ...
        //获取配置的非法字符
        String str = ApplicationContextUtil.getApplicationContext().getEnvironment().getProperty("xss.array");
