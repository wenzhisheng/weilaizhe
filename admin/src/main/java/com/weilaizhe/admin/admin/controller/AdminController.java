package com.weilaizhe.admin.admin.controller;

import com.weilaizhe.common.admin.service.IAdminService;
...
import com.weilaizhe.common.pojo.permission.dto.PermissionDTO;
...
public class AdminController {
    ...
    public Object login() {
        String token = CommonUtil.getToken(RedisKeyConst.ADMIN_TOKEN_COOKIE);
    ...
    public void insertAdminLoginLog(AdminVO user, HttpServletRequest request){
        AdminLoginLogVO adminLoginLogVO = new AdminLoginLogVO();
        //管理员账号
        adminLoginLogVO.setAdminAccount(user.getAccount());
        //登录ip
