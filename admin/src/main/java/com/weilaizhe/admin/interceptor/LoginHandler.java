package com.weilaizhe.admin.interceptor;
...
public class LoginHandler implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        RBucket<AdminVO> adminVO = redissonClient.getBucket(redisSessionKey);
        adminVO.expire(30, TimeUnit.MINUTES);
        AdminVO user = adminVO.get();
        ...
        // 单账号登录后台,否则删除上一个会话
        String redisToeknKey = MessageFormat.format(RedisKeyConst.REDIS_ADMIN_TOKEN, user.getAccount());
