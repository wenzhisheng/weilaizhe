package com.weilaizhe.admin.wechatmerchant.controller;
...
public class WechatMerchantController {
    ...
    public Object batchBinding(@RequestBody WechatMerchantVO wechatMerchantVO){
        return iWechatMerchantService.batchBinding(wechatMerchantVO);
    }
     ...
     */
    @PostMapping("/unbind")
    @ApiOperation(value="解绑",notes="必填字段：wechatMerchantId")
    public Object unbind(@RequestBody WechatMerchantVO wechatMerchantVO){
        return iWechatMerchantService.unbind(wechatMerchantVO);
    }
