...
/**
 * @author: dameizi
 * @description: 支付宝商户回调生产配置
 * @dateTime 2019-04-09 21:42
 * @className com.weilaizhe.mqueue.consumber.AlipayMerchantCallbackConfig
 */
@Configuration
public class AlipayMerchantCallbackConfig {

    private static final Logger logger = LogManager.getLogger(AlipayMerchantCallbackConfig.class);
    ...
    /** groupName topic tag */
    private String groupName = RocketmqConst.MQ_ALIPAY_MERCHANT_CALLBACK_GROUPNAME;
    private String topic = RocketmqConst.MQ_ALIPAY_MERCHANT_CALLBACK_TOPIC;
    private String tag = RocketmqConst.MQ_ALIPAY_MERCHANT_CALLBACK_TAG;

    @Bean(value = "alipayMerchantCallback")
