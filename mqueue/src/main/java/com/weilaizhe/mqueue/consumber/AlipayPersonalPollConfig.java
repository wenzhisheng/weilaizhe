...
/**
 * @author: dameizi
 * @description: 支付宝个人商户轮询生产配置
 * @dateTime 2019-04-09 20:02
 * @className com.weilaizhe.mqueue.consumber.AlipayPersonalPollConfig
 */
@Configuration
public class AlipayPersonalPollConfig {

    private static final Logger logger = LogManager.getLogger(AlipayPersonalPollConfig.class);
    ...
    /** groupName topic tag */
    private String groupName = RocketmqConst.MQ_ALIPAY_PERSONAL_POLL_GROUPNAME;
    private String topic = RocketmqConst.MQ_ALIPAY_PERSONAL_POLL_TOPIC;
    private String tag = RocketmqConst.MQ_ALIPAY_PERSONAL_POLL_TAG;

    @Bean(value = "alipayPersonalPoll")
